...
/*
function filterOut(arr: number[]): number[] {
    let genArr: number[] = [];
...
let myVar = filterOut(myNums);
console.log(myVar);
*/

/*
function sumArray(arr: number[]): number {
    let myArray: number = arr.reduce((a, b) => a + b);

    return myArray;
}

let mySum: number = sumArray(myNums);
console.log(mySum);
*/
...
const studentsDetailes: Student[] = [
